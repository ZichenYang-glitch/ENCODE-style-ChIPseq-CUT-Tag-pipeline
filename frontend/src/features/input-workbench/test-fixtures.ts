...
export function createAuthoringSchemaFixture(): WorkflowSchemaResponse {
  return {
    ...
    config_schema: {
      ...
      $id: 'https://encode-pipeline.org/schemas/test/config/1.0.0',
      type: 'object',
      title: 'Test config',
      properties: {
    ...
    sample_schema: {
      $schema: 'https://json-schema.org/draft/2020-12/schema',
      $id: 'https://encode-pipeline.org/schemas/test/samples/1.0.0',
      type: 'array',
      minItems: 1,
      maxItems: 1_000,
      items: {
    ...
    option_schema: {
      $schema: 'https://json-schema.org/draft/2020-12/schema',
      $id: 'https://encode-pipeline.org/schemas/test/options/1.0.0',
      type: 'object',
      properties: {
