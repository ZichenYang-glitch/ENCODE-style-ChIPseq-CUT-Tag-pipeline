...
_PUBLIC_ISSUE_EXIT_CODES = {
    ...
    "PLATFORM_RUNTIME_BUILD_ABI_INCOMPATIBLE": EXIT_INCOMPATIBLE,
    "PLATFORM_RUNTIME_BUILD_TOOL_UNAVAILABLE": EXIT_UNAVAILABLE,
    "PLATFORM_RUNTIME_CLOSURE_INVALID": EXIT_DATA,
    "PLATFORM_RUNTIME_LOCK_INVALID": EXIT_DATA,
}
