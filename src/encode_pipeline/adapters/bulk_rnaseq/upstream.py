...
PARAMETER_IMPACT_BY_NATIVE_NAME = {
    ...
    "remove_ribo_rna": "route_namespace",
    "ribo_database_manifest": "content_only",
    "ribo_removal_tool": "route_namespace",
    ...
    "save_non_ribo_reads": "additive_artifacts",
    ...
    "sortmerna_index": "route_namespace",
