...
EXECUTION_IMPLEMENTATION_PATHS = (
    ...
    "src/encode_pipeline/platform/authentication.py",
    ...
    "src/encode_pipeline/platform/notifications.py",
    ...
    "src/encode_pipeline/persistence/authentication.py",
    ...
    *EXECUTION_MIGRATION_REVISION_PATHS,
    ...
    "src/encode_pipeline/services/authentication_repositories.py",
    ...
    "src/encode_pipeline/services/smtp_transport.py",
    "src/encode_pipeline/services/terminal_notifications.py",
    ...
    "src/encode_pipeline/workers/terminal_notifications.py",
